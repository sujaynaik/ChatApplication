...
public class MyFont {
    ...
    private static final String ROBOTO = "Roboto-Regular.ttf";
    private static final String OPENSANS = "OpenSans-Regular.ttf";
    ...
    public Typeface getFontOpensans() {
        String font = folder + OPENSANS;
